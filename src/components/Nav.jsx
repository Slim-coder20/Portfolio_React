...
export default function Nav() {
  ...
  const mobileLinkClass = ({ isActive }) =>
    [
      ...
      isActive
        ? "text-amber-400"
        : "text-gray-200 dark:text-slate-300 hover:text-white hover:bg-white/10 dark:hover:bg-white/5",
    ].join(" ");
      ...
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="h-16 flex items-center justify-between">
          ...
          <NavLink to="/" className="inline-flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-md bg-amber-500/20 text-amber-400 ring-1 ring-amber-400/30">
              ...
              >
                <path
                  fill="currentColor"
                  d="M12 2L2 7l10 5l10-5zM2 17l10 5l10-5M2 12l10 5l10-5"
                />
              </svg>
            </span>
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-md p-2 text-gray-200 hover:bg-white/10 hover:text-amber-400 transition-all focus:outline-none focus:ring-2 focus:ring-amber-500 "
